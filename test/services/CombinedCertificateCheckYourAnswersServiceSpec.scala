...
class CombinedCertificateCheckYourAnswersServiceSpec extends SpecBase with GuiceOneAppPerSuite {

  "CombinedCertificateCheckYourAnswersService must generate the summaryList when all the userAnswers" - {

    def SUT = app.injector.instanceOf[CombinedCertificateCheckYourAnswersService]

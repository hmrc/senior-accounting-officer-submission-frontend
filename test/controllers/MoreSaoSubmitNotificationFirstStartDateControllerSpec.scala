...
class MoreSaoSubmitNotificationFirstStartDateControllerSpec extends SpecBase with MockitoSugar {
  ...
  val formProvider = new MoreSaoSubmitNotificationFirstStartDateFormProvider()
  ...
  "MoreSaoSubmitNotificationFirstStartDate Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, moreSaoSubmitNotificationFirstStartDateRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(MoreSaoSubmitNotificationFirstStartDatePage, true).success.value

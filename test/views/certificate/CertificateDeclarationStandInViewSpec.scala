...
import views.html.certificate.CertificateDeclarationStandInView

import CertificateDeclarationStandInViewSpec.*
      ...
      s"when using $mode" - {
        "when the form is not filled in" - {
          ...
          doc.createTestsWithSubmissionButton(
            action = controllers.certificate.routes.CertificateDeclarationStandInController.onSubmit(mode),

...
import views.CombinedWhoSubmitsCertificateViewSpec.*
...
class CombinedWhoSubmitsCertificateViewSpec extends ViewSpecBase[CombinedWhoSubmitsCertificateView] {
  ...
  "CombinedWhoSubmitsCertificateView" - {
      ...
      s"when using $mode" - {
        "when the form is not filled in" - {
          ...
          doc.createTestsWithSubmissionButton(
            action = controllers.routes.CombinedWhoSubmitsCertificateController.onSubmit(mode),
            buttonText = "Continue"
          )
...
object CombinedWhoSubmitsCertificateViewSpec {

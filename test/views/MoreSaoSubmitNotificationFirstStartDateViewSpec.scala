...
class MoreSaoSubmitNotificationFirstStartDateViewSpec extends ViewSpecBase[MoreSaoSubmitNotificationFirstStartDateView] {
...
object MoreSaoSubmitNotificationFirstStartDateViewSpec {
  val pageHeading = "moreSaoSubmitNotificationFirstStartDate"
  val pageTitle = "moreSaoSubmitNotificationFirstStartDate"
  val yesKey = "true"
  val yesLabel = "Yes"
  val noKey = "false"
  val noLabel = "No"

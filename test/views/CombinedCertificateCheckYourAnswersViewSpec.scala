...
class CombinedCertificateCheckYourAnswersViewSpec extends ViewSpecBase[CombinedCertificateCheckYourAnswersView] {
  ...
  "CombinedCertificateCheckYourAnswersView" - {
    ...
    doc.createTestsWithSubmissionButton(
      action = routes.CombinedCertificateCheckYourAnswersController.onSubmit(),
...
object CombinedCertificateCheckYourAnswersViewSpec {

...
class SaoNameController @Inject() (
    ...
    formProvider: SaoNameFormProvider,
    ...
    implicit request =>
      form
        ...
        .fold(
          ...
          value =>
            for {
              updatedAnswers <- Future.fromTry(request.userAnswers.set(SaoNamePage, value))
              _              <- sessionRepository.set(updatedAnswers)
            } yield Redirect(navigator.nextPage(SaoNamePage, mode, updatedAnswers))
        )
  }
}
